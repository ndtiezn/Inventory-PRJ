@extends('backend.layouts.master_fullpage')
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-4">
                                <div class="checkbox">
                                        ...
                                        <input type="checkbox" name="nv_ghinhodangnhap" {{ old('remember') ? 'checked' : '' }}> Ghi nhớ đăng nhập
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-right">
                                    <button class="btn btn-link px-0" type="{{ route('password.request') }}">Quên mật khẩu?</button>
                                </div>
                            </div>
                        </div>
                    </div>
